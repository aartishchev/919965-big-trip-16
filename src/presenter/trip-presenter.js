...
export default class tripPresenter {
  ...
  #renderEvent = (event, descriptions, destinations) => {
    ...
    eventPresenter.init(event, descriptions, destinations);
  ...
  #renderTripEvents = () => {
    for (let i = 0; i < this.#events.length; i++) {
      this.#renderEvent(this.#events[i], this.#descriptions, this.#destinations);
    }
  }
